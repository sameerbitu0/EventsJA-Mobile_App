...
export default function ProgressCircle2() {
  ...
  const getEventsDetails = async () => {
    try {
      ...
      //First Circle
      var TotalCheckIns = eventsDetailsData.totalCheckIns;
      var TotalSales = eventsDetailsData.totalSales;
      var PercentageFormula = (TotalCheckIns / TotalSales) * 100;
    ...
    <View style={styles.circleContainer}>
      <Svg width={size} height={size}>
        ...
        <Text      
          ...
          fontSize={9}
          fill="black">
          {eventsDetailsData?`${eventsDetailsData.totalCheckIns} / ${eventsDetailsData.totalSales}`:'loading..'}
